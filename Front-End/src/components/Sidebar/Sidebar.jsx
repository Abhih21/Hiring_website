  ...
  return (
    <>
      ...
      <div className="flex fixed h-screen">
        {/* Sidebar */}
        <div
          className={`h-screen w-72 bg-custom-sidebar text-custom-text flex flex-col transition-transform transform ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0 lg:relative absolute z-10`}
        >
